    ...
    <table>
        <thead>
            <tr style ="color: #D4D4C9; font-size: 100%; font-family: Arial  ;">
                <th class="text-left" style="width: 25%;"><strong>To-Do</strong></th>
        ...
        <tbody>
            <?php foreach($roverchecklist as $checklist):?>
                <tr style ="color: #D4D4C9; font-size: 100%; background-color:#1E1E1E;">
                    <td class="text-left"><div class="mobile-only"><strong>To-Do</strong></div><strong><?php echo $checklist['item']; ?></strong></td>
                    ...
                    <?php if ($checklist['status']!="Completed"):?>
                        <a href="checkin.php?id=<?php echo $checklist['id'];?>"class="btn btn-warning btn-xs"  
                        title="Check In" data-toggle="tooltip"><span class="glyphicon glyphicon-ok"></span></a>
                    <?php else:?>
                        <a href="checkout.php?id=<?php echo $checklist['id'];?>"class="btn btn-success btn-xs"  
