 ...
 */
ob_start();
$pageName = "RFID Badge Users";
require_once '../database/load.php';
include '../pages/header.php';


$users = find_all_RFID_user();
$nusers = find_all_user();
...
<div class="panel-box">
    ...
    <button type="button" class="btn btn-primary btn-lg" id ="add" data-toggle="modal" data-target="#add_data_modal" VALIGN=MIDDLE>
        ...
        <strong>Register New Badge</strong>
    </button>
    ...
    <table>
        <thead>
            <tr style ="color: #D4D4C9; font-size: 20px; font-family: Arial  ;">
                ...
                <th class="text-center" style="width: 5%;"><strong>ID</strong></th>
                <!-- <th class="text-center" style="width: 5%;"><strong>Last</strong></th> -->
                <th class="text-center" style="width: 5%;"><strong>Status</strong></th>
                <th class="text-center" style="width: 5%;"><strong>Date Created</strong></th>
                <th class="text-center" style="width: 5%;"><strong>Date Updated</strong></th>
        ...
        <tbody>
            ...
            ?>
                <tr style ="color: #D4D4C9; font-size: 100%; background-color:#1E1E1E;">
                    ...
                    <td><div class="mobile-only"><strong>ID</strong></div><?php echo $user['tagid']; ?></td>
                    <td><div class="mobile-only"><strong>Status</strong></div><?php if($user['Status']=='0'){echo "Inactive";}else{echo "Active";}?></td>
                    <td><div class="mobile-only"><strong>Date Created</strong></div><?php echo $user['createdTimeStamp']; ?></td>
                    <td><div class="mobile-only"><strong>Date Updated</strong></div><?php echo $user['updatedTimeStamp']; ?></td>
                    ...
                    <?php include '../rfid/edit_password_modal.php'; ?>
                </tr>
            <?php endforeach;?>     
        </tbody>
    </table>
